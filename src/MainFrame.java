...
public class MainFrame extends JFrame {
    ...
    private MainFrame.PaintPanel paintPanel;
    ...
    private class MakeObjButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                MainObj.createObj();
                paintPanel.repaint();
                System.out.print(paintPanel.getSize());
    ...
    public static class PaintPanel extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            ...
            for (Line3D line : SimpleStore.Lines) {
                ...
                g.drawLine((int) SimpleStore.Points.get(p1).getX(),
                        (int) SimpleStore.Points.get(p1).getY(),
                        (int) SimpleStore.Points.get(p2).getX(),
                        (int) SimpleStore.Points.get(p2).getY());
            }
        }
    }
}
